...
public interface IExcerciseTradingController {
    ...
    ResponseEntity<ObjectResponse> createExcerciseTrading(@RequestBody ExerciseTradingDTO exerciseTradingDTO);//Method that creates an exercise
    @GetMapping()//Annotation that represent the header of an HTTP query that reads an exercise with a GET query
    ResponseEntity<ObjectResponse> readExcerciseTrading(@RequestBody ExerciseTradingDTO exerciseTradingDTO);//Method that reads an exercise
    ...
    ResponseEntity<ObjectResponse> updateExcerciseTrading(@RequestBody ExerciseTradingDTO exerciseTradingDTO);//Method that updates an exercise
