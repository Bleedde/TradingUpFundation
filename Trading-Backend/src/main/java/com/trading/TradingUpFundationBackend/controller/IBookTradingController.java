...
public interface IBookTradingController {
    ...
    ResponseEntity<ObjectResponse> createBookTrading(@RequestBody BookTradingDTO bookTradingDTO);//Method that creates a book
    @GetMapping()//Annotation that represent the header of an HTTP query that reads a book with a GET query
    ResponseEntity<ObjectResponse> readBookTrading(@RequestBody BookTradingDTO bookTradingDTO);//Method that reads a book
    ...
    ResponseEntity<ObjectResponse> updateBookTrading(@RequestBody BookTradingDTO bookTradingDTO);//Method that updates a book
