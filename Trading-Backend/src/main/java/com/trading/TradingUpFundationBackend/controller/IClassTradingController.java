...
public interface IClassTradingController {
    ...
    ResponseEntity<GenericResponseDTO> createClassTrading(@RequestBody ClassTradingDTO classTradingDTO);//Method that creates a class
    @GetMapping()//Annotation that represent the header of an HTTP query that reads a class with a GET query
    ResponseEntity<GenericResponseDTO> readClassTrading(@RequestBody ClassTradingDTO classTradingDTO);//Method that reads a class
    ...
    ResponseEntity<GenericResponseDTO> updateClassTrading(@RequestBody ClassTradingDTO classTradingDTO);//Method that updates a class
    @DeleteMapping//Annotation that represent the header of an HTTP query that deletes a class with a DELETE query
    ResponseEntity<GenericResponseDTO> deleteBookTrading(@PathVariable Integer classId);//Method that deletes a class
}
