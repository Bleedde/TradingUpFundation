...
import com.trading.TradingUpFundationBackend.Commons.Domains.Entity.AdminTradinEntity.AdminTradingEntity;//Import the entity "Admin" to represent the relation between these entities
...
public class UserTradingEntity {
    ...
    @OneToMany(mappedBy = "userTradingEntityRelation", cascade = CascadeType.ALL, orphanRemoval = true)//Annotation to represent a relation "One" to "Many" where it is mapped the attribute in the another entity who represent the side "Many"
