 ...
 */
public interface IClassPrerecordedTradingResponse {
    ...
    String CLASS_PRERECORDED_DELETE_SUCCESS = "Successful class prerecorded deleted";//If the class prerecorded could be deleted
