...
public interface IExerciseTradingEndPoints {
    ...
    String URL_EXERCISE_DELETE = "/exercise_delete";//Delete a exercise area
    String URL_EXERCISE_UPDATE = "/exercise_update";//Update a exercise area
    String URL_EXERCISE_SEARCH = "/exercise_search";//Search a exercise area
    String URL_EXERCISES_SEARCH = "/exercise_search";//Search all the exercises area
}
