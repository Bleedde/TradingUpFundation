...
public interface IClassTradingEndPoints {
    ...
    String URL_CLASS_DELETE = "/class_delete";//Delete a class area
    String URL_CLASS_UPDATE = "/class_update";//Update a class area
    String URL_CLASS_SEARCH = "/book_search";//Search a class area
    String URL_CLASSES_SEARCH = "/books_search";//Search all the classes area
}
