...
public interface IClassPrerecordedeResponse {
    ...
    String CLASS_PRERECORDED_UPDATE_FAILED = "Failed class prerecorded update";
    String CLASS_PRERECORDED_DELETE_SUCCESS = "Succesfull class prerecorded deleted";
    String CLASS_PRERECORDED_DELETE_FAILED = "Failed class prerecorded deleted";
    String CLASS_PRERECORDED_SEARCHED_FAILED = "Failed class prerecorded searched";
}
