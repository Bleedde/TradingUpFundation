...
/**
 * Interface who contains the endpoints of each controller of the entity LevelTrading
 */
public interface ILevelTradingEndPoints {
    String URL_LEVEL = "/level";//Go to de level area
